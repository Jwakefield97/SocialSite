...
$("#pills-feed-tab").click()):"pills-feed-tab"===b&&(b="pills-feed-tab",$("#pills-feed-tab").click())));c=0},!1);650>$(window).width()&&($("#usersFullTable").addClass("table-responsive"),$("#friendsPendingFullTable").addClass("table-responsive"),$("#friendsFullTable").addClass("table-responsive"));$(window).resize(function(a){650>$(window).width()?($("#usersFullTable").addClass("table-responsive"),$("#friendsPendingFullTable").addClass("table-responsive"),$("#friendsFullTable").addClass("table-responsive")):
