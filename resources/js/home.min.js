...
4)))a=!0;return a};if(window.mobilecheck()||550>$(window).width())$("#usersFullTableW").addClass("table-responsive"),$("#friendsPendingFullTableW").addClass("table-responsive"),$("#friendsFullTableW").addClass("table-responsive");$(window).resize(function(a){window.mobilecheck()||550>$(window).width()?($("#usersFullTableW").addClass("table-responsive"),$("#friendsPendingFullTableW").addClass("table-responsive"),$("#friendsFullTableW").addClass("table-responsive")):($("#usersFullTableW").removeClass("table-responsive"),
$("#friendsPendingFullTableW").removeClass("table-responsive"),$("#friendsFullTableW").removeClass("table-responsive"))});getPosts();$('[data-toggle="tooltip"]').tooltip();$("#createPost").click(function(a){$("#modalPostText").val("");$("#createPostModal").modal("show")});$("#pills-feed-tab").click(function(a){b="pills-feed-tab";getPosts()});$("#createPostModalButton").click(function(a){$("#createPostModal").modal("hide");a=$("#modalPostText").val().trim();0===a.length&&2E3===a.length||$.ajax({type:"POST",
